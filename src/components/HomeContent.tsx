        ...
        <div className="grid grid-cols-3 items-center">
          ...
          <div className="flex justify-end pr-4 gap-2">
            ...
            >
              ...
              {historique.length > 0 && (
                <span className="absolute -top-1 -right-1 bg-muted text-background text-[10px] font-bold rounded-full min-w-[16px] h-4 flex items-center justify-center px-1 leading-none pointer-events-none z-10">
                  {historique.length}
                </span>
              )}
            </GlassButton>
